import type { CircleFlags, Fa6Brands, Fa6Solid, Ri, SimpleIcons, Mdi } from 'iconify-icon-names';
 ...
 */
export type IconName = Fa6Brands | Fa6Solid | SimpleIcons | CircleFlags | Ri | Mdi;
